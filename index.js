...
app.get("/", (req, res) => {
    ...
    res.send(`
        ...
        <head>
            ...
            <title>แดชบอร์ด | ระบบจัดการบอท</title>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/bots">ดูบอทรัน</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/commands">คำสั่งที่ใช้</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/add">เพิ่มบอท</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/bots">ดูบอทรัน</a>
                            </li>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/bots">ดูบอทรัน</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/commands">คำสั่งที่ใช้</a>
                            </li>
        ...
        <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/commands">คำสั่งที่ใช้</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="command-list" id="commandList">
                                ${commandDescriptions.map(cmd => `
                                    <div class="command-item">
                                        ...
                                        <span class="usage-count">${cmd.usage || 0} ครั้ง</span>
            ...
            <script>
                ...
                socket.on('updateCommands', (data) => {
                    updateCommands(data.commandDescriptions);
                });
            </script>
        </body>
        </html>
...
// เส้นทาง API สำหรับส่งข้อมูลบอท
app.get("/api/bots", (req, res) => {
    res.json(generateBotData());
});

// เส้นทาง API สำหรับส่งข้อมูลคำสั่ง
app.get("/api/commands", (req, res) => {
    res.json({ commandDescriptions });
});

// เส้นทางเริ่มต้นของบอท
...
// เส้นทางดูคำสั่งที่ใช้แบบหน้าแยก
app.get("/commands", (req, res) => {
    res.send(`
        <!DOCTYPE html>
        <html lang="th">
...
io.on('connection', (socket) => {
    console.log(chalk.green('🔌 ผู้ใช้เชื่อมต่อผ่าน Socket.io'));

    // ส่งข้อมูลบอทปัจจุบันเมื่อผู้ใช้เชื่อมต่อ
    socket.emit('updateBots', generateBotData());

    // ส่งข้อมูลคำสั่งปัจจุบันเมื่อผู้ใช้เชื่อมต่อ
    socket.emit('updateCommands', { commandDescriptions });

    socket.on('disconnect', () => {
        console.log(chalk.yellow('🔌 ผู้ใช้ยกเลิกการเชื่อมต่อ Socket.io'));
    });
});
