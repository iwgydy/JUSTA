...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "คุณ",
    description: "ดึงภาพปฏิทินจาก API",
    commandCategory: "ทั่วไป",
    usages: "ปฏิทิน [@ชื่อคน | ไม่ต้องแท็กก็ได้]",
    cooldowns: 0
};
...
module.exports.run = async function({ api, event, args }) {
    ...
    const apiUrl = `https://api-canvass.vercel.app/calendar?userid=${userID}`; // ใช้ API สำหรับปฏิทิน
    ...
    try {
        ...
        return api.sendMessage("❌ เกิดข้อผิดพลาดในการดึงภาพปฏิทิน กรุณาลองใหม่!", event.threadID, event.messageID);
    }
};
