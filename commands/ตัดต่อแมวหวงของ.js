...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "คุณ",
    description: "สร้างภาพแมวหวงของจาก API",
    commandCategory: "ทั่วไป",
    usages: "แมวหวงของ [@ชื่อคน | ไม่ต้องแท็กก็ได้]",
    cooldowns: 0
};
...
module.exports.run = async function({ api, event, args }) {
    ...
    const apiUrl = `https://api-canvass.vercel.app/kitty?userid=${userID}`; // URL API สำหรับแมวหวงของ
    ...
    try {
        ...
        return api.sendMessage("❌ เกิดข้อผิดพลาดในการสร้างภาพแมวหวงของ กรุณาลองใหม่!", event.threadID, event.messageID);
    }
};
