...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "คุณ",
    description: "สร้างภาพตัดต่อ รับรางวัล (Obama Award) จาก API",
    commandCategory: "ทั่วไป",
    usages: "รับรางวัล [@ชื่อคน | ไม่ต้องแท็กก็ได้]",
    cooldowns: 0
};
...
module.exports.run = async function({ api, event, args }) {
    ...
    const apiUrl = `https://api-canvass.vercel.app/obama?userid=${userID}`; // URL API สำหรับสร้างภาพตัดต่อ
